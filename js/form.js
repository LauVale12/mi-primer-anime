...
const apiURL = "https://boot-back-end.vercel.app/"
...
async function enviarDatosFormulario() {
    ...
    try {
        ...
        const response = await fetch(apiURL+'api/clientes/add', { 
            method: 'POST',
            headers: {
...
async function loginEnviarDatosFormulario() {
    ...
    try {
        ...
        const response = await fetch(apiURL+'api/clientes/login');
...
async function enviarDatosFormularioAnime() {
    ...
    try {
        // Envía los datos al backend
        const response = await fetch(apiURL+'api/clientes/addAnime', { 
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
